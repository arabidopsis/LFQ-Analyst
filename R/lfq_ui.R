...
btn2div <- function(btn) {
  div(btn, class = "ps-1", style = "margin-top:1.4em;")
}
...
quick_start_page <- function() {
  bslib::card(
    ...
    bslib::card_header(class = "bg-success text-light", "Getting Started"),
    ...
    br(),
    tags$img(src = "./static/img/LFQ_analyst.svg", class = "w-50 mx-auto d-block")
  )
}
