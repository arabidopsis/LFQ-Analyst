    ...
    dashboardPage(
      ...
      dashboardSidebar(
        ...
        sidebarMenu(
          ...
          convertMenuItem(menuItem("User Guide",
            icon = icon("question"),
      ...
      dashboardBody(
          ...
          tabItem(
            ...
            fluidRow(
              box(
                ...
                h5(tags$ul(
                  "Get access to additional Analyst Apps: ", tags$a(
                    href = "https://analyst-suites.org/",
                ...
                h5(tags$ul(
                  "Includes more features: ", tags$a(
                    href = "https://analyst-suites.org/apps/lfq-analyst-dev/",
                ...
                h5(tags$ul(
                  "Leave comments to our GitHub: ", tags$a(
                    href = "https://github.com/MonashBioinformaticsPlatform/LFQ-Analyst",
                    target = "_blank", "here"
                  )
                )),
                width = 12,
          ...
          tabItem(
            ...
            fluidRow(
              box(
                ...
                #                                       target='_blank', 'here'))))),
                div(p(HTML(paste0(
                  "A detailed user manual can be accessed",
                  a(
                    href = "./LFQ-Analyst_manual.pdf",
			  ...
			  Monash Proteomics and Metabolomics Platform:"),
                ...
                div(p(HTML(paste0(
                  "Please Cite: Shah AD, Goode RJA, Huang C, Powell DR, Schittenhelm RB.
		...
		visualize proteomics data preprocessed with MaxQuant. DOI:",
                  a(
                    href = "https://pubs.acs.org/doi/10.1021/acs.jproteome.9b00496",
                    ...
                    tabPanel(
                      ...
                      fluidRow(
                        ...
                        column(
                          6,
                          selectInput(
                            "pathway_database_dm", "Pathway database:",
                            c(
                              "KEGG" = "KEGG_2021_Human",
                              "Reactome" = "Reactome_2022"
                            )
